...
*/
				...
				for(int i = 0; i < 32; i++){
					...
					temp_unlock_code[i] = 0b0; //initilised temp_unlockcode back to 0b0
           			...
           			//shift new array 5 spaces
           			temp_unlock_code[0] = unlock_code[5];
           			temp_unlock_code[1] = unlock_code[6];
           			temp_unlock_code[2] = unlock_code[7];
           			temp_unlock_code[3] = unlock_code[8];
           			temp_unlock_code[4] = unlock_code[9];
           			temp_unlock_code[5] = unlock_code[10];
           			temp_unlock_code[6] = unlock_code[11];
           			temp_unlock_code[7] = unlock_code[12];
           			temp_unlock_code[8] = unlock_code[13];
           			temp_unlock_code[9] = unlock_code[14];
           			temp_unlock_code[10] = unlock_code[15];
           			temp_unlock_code[11] = unlock_code[16];
           			temp_unlock_code[12] = unlock_code[17];
           			temp_unlock_code[13] = unlock_code[18];
           			temp_unlock_code[14] = unlock_code[19];
           			temp_unlock_code[15] = unlock_code[20];
           			temp_unlock_code[16] = unlock_code[21];
           			temp_unlock_code[17] = unlock_code[22];
           			temp_unlock_code[18] = unlock_code[23];
           			temp_unlock_code[19] = unlock_code[24];
           			temp_unlock_code[20] = unlock_code[25];
           			temp_unlock_code[21] = unlock_code[26];
           			temp_unlock_code[22] = unlock_code[27];
           			temp_unlock_code[23] = unlock_code[28];
           			temp_unlock_code[24] = unlock_code[29];
           			temp_unlock_code[25] = unlock_code[30];
           			temp_unlock_code[26] = unlock_code[31];
           			temp_unlock_code[27] = unlock_code[0];
           			temp_unlock_code[28] = unlock_code[1];
           			temp_unlock_code[29] = unlock_code[2];
           			temp_unlock_code[30] = unlock_code[3];
           			temp_unlock_code[31] = unlock_code[4];
